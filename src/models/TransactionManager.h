...
public:
    ...
    static const RegularTransfer &createTransaction(const QDateTime &, const Account &, const Account &, const CASH_AMOUNT_T &, const int&);
    static const CashTransaction &createTransaction(const QDateTime &, const Account &, const ACCOUNT_BALANCE_AMOUNT_T &, const bool&);
    static const AccountManaging &createTransaction(const QDateTime &, const Account &,  const CARD_NUMBER_T & , const AccountManaging::ValueChanged &, const VAL&, const VAL&);
};
