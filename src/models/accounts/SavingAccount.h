...
public:
    SavingAccount(const int &ownerId, const std::string &IBAN, const BANK_NUMBER_T &bank, const ACCOUNT_BALANCE_AMOUNT_T &limit,
                  const float &interestRate, const ACCOUNT_BALANCE_AMOUNT_T &money) :
